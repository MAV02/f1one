...
type SingaporeLayoutProps = {
  session: string;
};

const SingaporeLayout: React.FC<SingaporeLayoutProps> = ({
  session,
}) => {
  return (
    <div className="rounded-md border p-4 shadow-md bg-gray-900 text-white">
      <h3 className="text-lg font-semibold mb-2">Singapore Circuit</h3>
...
export default SingaporeLayout;
