...
type AzerbaijanLayoutProps = {
  session: string;
};

const AzerbaijanLayout: React.FC<AzerbaijanLayoutProps> = ({
  session,
}) => {
  return (
    <div className="rounded-md border p-4 shadow-md bg-gray-900 text-white">
      <h3 className="text-lg font-semibold mb-2">Azerbaijan Circuit</h3>
...
export default AzerbaijanLayout;
