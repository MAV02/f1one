...
type LasVegasLayoutProps = {
  session: string;
};

const LasVegasLayout: React.FC<LasVegasLayoutProps> = ({
  session,
}) => {
  return (
    <div className="rounded-md border p-4 shadow-md bg-gray-900 text-white">
      <h3 className="text-lg font-semibold mb-2">LasVegas Circuit</h3>
