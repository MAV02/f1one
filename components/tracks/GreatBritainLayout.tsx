...
type GreatBritainLayoutProps = {
  session: string;
};

const GreatBritainLayout: React.FC<GreatBritainLayoutProps> = ({
  session,
}) => {
  return (
    <div className="rounded-md border p-4 shadow-md bg-gray-900 text-white">
      <h3 className="text-lg font-semibold mb-2">GreatBritain Circuit</h3>
...
export default GreatBritainLayout;
