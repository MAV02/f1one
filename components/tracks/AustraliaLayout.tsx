...
type AustraliaLayoutProps = {
  session: string;
};

const AustraliaLayout: React.FC<AustraliaLayoutProps> = ({
  session,
}) => {
  return (
    <div className="rounded-md border p-4 shadow-md bg-gray-900 text-white">
      <h3 className="text-lg font-semibold mb-2">Australia Circuit</h3>
...
export default AustraliaLayout;
