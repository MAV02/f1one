...
type NetherlandsLayoutProps = {
  session: string;
};

const NetherlandsLayout: React.FC<NetherlandsLayoutProps> = ({
  session,
}) => {
  return (
    <div className="rounded-md border p-4 shadow-md bg-gray-900 text-white">
      <h3 className="text-lg font-semibold mb-2">Netherlands Circuit</h3>
...
export default NetherlandsLayout;
